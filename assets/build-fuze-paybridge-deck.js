...
slide.addText('• Margin compression for MENA merchants\n• Poor user experience on super apps\n• Trapped working capital', { x: 5.7, y: 2.1, w: 3.6, fontSize: 12, color: C.lgray, bullet: true, lineSpacing: 20 });

// SLIDE 3: The Solution
slide = prs.addSlide({ masterName: 'FUZE_MASTER' });
slide.addText('PayBridge Architecture', { x: 0.5, y: 0.5, w: 5, fontSize: 20, bold: true, color: C.accent });

slide.addText('❌ Legacy Rails', { x: 0.5, y: 1.5, w: 3, fontSize: 16, bold: true, color: C.lgray });
slide.addText('• Nostro/Vostro accounts\n• Manual FX quoting\n• Batch processing', { x: 0.5, y: 2, w: 3, fontSize: 13, color: C.lgray, bullet: true, lineSpacing: 24 });

slide.addText('✅ Fuze PayBridge API', { x: 6, y: 1.5, w: 3, fontSize: 16, bold: true, color: C.accent });
slide.addText('• Stablecoin liquidity pools\n• Algorithmic FX execution\n• T+0 atomic settlement\n• 100% white-labeled', { x: 6, y: 2, w: 3, fontSize: 13, color: C.white, bullet: true, lineSpacing: 24 });
