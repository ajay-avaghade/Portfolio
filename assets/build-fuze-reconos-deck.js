...
slide.addText('• Manual spreadsheet reconciliation\n• Disconnect between on-chain & off-chain data\n• High operational overhead\n• Regulatory compliance risk', { x: 0.7, y: 2.1, w: 3.6, h: 2.5, valign: "top", fontSize: 12, color: C.lgray, bullet: true, lineSpacing: 20 });
...
slide.addText('• Stalled B2B partner scaling\n• Delayed merchant payouts\n• Costly compliance audits', { x: 5.7, y: 2.1, w: 3.6, h: 2.5, valign: "top", fontSize: 12, color: C.lgray, bullet: true, lineSpacing: 20 });

// SLIDE 3: The Solution
slide = prs.addSlide({ masterName: 'FUZE_MASTER' });
slide.addText('ReconOS Architecture', { x: 0.5, y: 0.5, w: 5, h: 0.6, valign: "top", fontSize: 20, bold: true, color: C.accent });

slide.addText('❌ Legacy Operations', { x: 0.5, y: 1.5, w: 3, h: 0.4, valign: "top", fontSize: 16, bold: true, color: C.lgray });
slide.addText('• Siloed databases\n• T+1 batch matching\n• High human error rate', { x: 0.5, y: 2, w: 3, h: 2.5, valign: "top", fontSize: 13, color: C.lgray, bullet: true, lineSpacing: 24 });

slide.addText('✅ Fuze ReconOS', { x: 6, y: 1.5, w: 3, h: 0.4, valign: "top", fontSize: 16, bold: true, color: C.accent });
slide.addText('• Unified data layer\n• Auto-matching engine\n• Proactive risk flagging\n• 100% automated settlement', { x: 6, y: 2, w: 3, h: 2.5, valign: "top", fontSize: 13, color: C.white, bullet: true, lineSpacing: 24 });
